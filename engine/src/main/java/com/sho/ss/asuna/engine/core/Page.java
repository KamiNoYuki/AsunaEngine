...
import com.sho.ss.asuna.engine.core.selector.Selectable;
 ...
 * {@link #getResultItems()} get extract results to be used in {@link com.sho.ss.asuna.engine.core.pipeline.Pipeline}<br>
 * {@link #addTargetRequests(Iterable)} {@link #addTargetRequest(String)} add urls to fetch                 <br>
 *
 * @author code4crafter@gmail.com <br>
 * @see com.sho.ss.asuna.engine.core.downloader.Downloader
...
public class Page {
    ...
    private final ResultItems resultItems = new ResultItems();
